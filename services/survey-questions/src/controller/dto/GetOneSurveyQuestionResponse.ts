...
export class GetOneSurveyQuestionResponse {
     ...
     * @param model
     */
    static createFromSurveyQuestionModel(model: ISurveyQuestion): GetOneSurveyQuestionResponse {

        let instance = new GetOneSurveyQuestionResponse();
